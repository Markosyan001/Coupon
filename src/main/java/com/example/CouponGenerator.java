...
public class CouponGenerator extends Application {
    private static final Logger logger = Logger.getLogger(CouponGenerator.class.getName());
            ...
            for (Page page : pdfDocument.getPages()) {
                ...
                for (TextFragment textFragment : absorber.getTextFragments()) {
                    if (promoCodeIterator.hasNext()) {
                        ...
                        logger.info("Added template page to the document. ADD TEXTS: " + in++);
                        progress += (1.0 / promoCodes.size());
